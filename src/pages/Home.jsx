...
function Home() {
  ...
  useEffect(() => {
    // Services à proximité avec coordonnées GPS
    const services = [
      {
        id: 1,
      ...
      },
      {
        ...
        lng: 47.4979,
        price: '35€/h',
        description: 'Installation et réparation électrique pour professionnels et particuliers.'
      },
      {
        id: 4,
        title: 'Ménage Propreté',
        category: 'Ménage',
        location: 'Antananarivo',
        rating: 4.3,
        reviews: 56,
        ...
        lng: 47.5279,
        price: '12€/h',
        description: 'Service de ménage et nettoyage pour votre maison ou bureau.'
      }
    ]
  ...
  return (
    <main className="bg-white text-black">
      {/* Section Accueil avec Leaflet Map */}
      <section id="accueil" className="relative overflow-hidden px-5 pb-20 pt-28 sm:px-8 md:pb-28 lg:px-10">
        <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.05fr_.95fr]">
          <div className="max-w-2xl animate__animated animate__fadeInUp">
            <span className="inline-flex rounded-full bg-yellow-50 px-4 py-2 text-sm font-semibold text-yellow-400 animate__animated animate__pulse animate__infinite">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
              <a href="#apropos" className="group inline-flex items-center justify-center gap-2 rounded-full bg-yellow-400 px-7 py-4 text-sm font-semibold text-white transition-all duration-300 hover:bg-yellow-500 hover:scale-105 hover:shadow-lg hover:shadow-yellow-400/30 animate__animated animate__bounceIn">
                En savoir plus 
                <FiArrowRight className="transition-transform duration-300 group-hover:translate-x-1" />
              </a>
              <a href="#service" className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-200 bg-white px-7 py-4 text-sm font-semibold text-black transition-all duration-300 hover:border-yellow-400 hover:text-yellow-400 hover:scale-105 hover:shadow-lg animate__animated animate__bounceIn animate__delay-1s">
                Nos services
              </a>
            </div>
          </div>
          ...
          {/* Leaflet Map intégré */}
          <div className="relative mx-auto w-full max-w-[520px] animate__animated animate__fadeInRight">
            <div className="absolute -right-6 top-10 h-36 w-36 rounded-full bg-yellow-50 blur-2xl animate__animated animate__pulse animate__infinite" />
            <div className="absolute -left-10 bottom-6 h-28 w-28 rounded-full bg-yellow-50 blur-2xl animate__animated animate__pulse animate__infinite" />
            
            <div className="relative overflow-hidden rounded-[2rem] border border-zinc-200 bg-white p-5 shadow-[0_30px_90px_-40px_rgba(234,179,8,0.35)] transition-all duration-500 hover:shadow-[0_30px_90px_-20px_rgba(234,179,8,0.5)] hover:scale-[1.02]">
              {/* En-tête de la carte */}
              <div className="flex items-center justify-between rounded-3xl bg-yellow-50 px-5 py-4 mb-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.24em] text-yellow-400/80">Carte moderne</p>
                  <p className="mt-2 text-sm font-bold text-black">Prestataires à proximité</p>
                </div>
                <div className="grid h-11 w-11 place-items-center rounded-2xl bg-yellow-400 text-white transition-all duration-300 hover:rotate-12 hover:scale-110">
                  <FiMapPin />
                </div>
              </div>

              {/* Leaflet Map View */}
              <div className="relative h-[360px] overflow-hidden rounded-[1.8rem] bg-yellow-50">
                <LeafletMap 
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {nearbyServices.map((service) => (
                  <span key={service.id} className="inline-flex items-center gap-1 rounded-full bg-yellow-50 px-3 py-1 text-xs font-medium text-yellow-600">
        ...
        <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[.95fr_.95fr] lg:items-center">
          <div className="space-y-6 animate__animated animate__fadeInLeft">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:border-yellow-400 animate__animated animate__fadeInUp animate__delay-1s">
              ...
              <div className="rounded-[2rem] border border-zinc-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-lg hover:border-yellow-400 animate__animated animate__fadeInUp animate__delay-2s">
      ...
      {/* Section Services */}
      <section id="service" className="border-y border-zinc-100 bg-yellow-50 px-5 py-20 sm:px-8 lg:px-10">
      ...
      {/* Section Démo */}
      <section id="demo" className="bg-yellow-50 px-5 py-20 sm:px-8 lg:px-10">
